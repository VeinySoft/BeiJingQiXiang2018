 ...
 * **********************************************************************
 */
class CXX_API NcTypedComponent
{
  public:
 ...
 * **********************************************************************
 */
class CXX_API NcVar : public NcTypedComponent
{
  public:
    virtual ~NcVar( void );
    NcToken name( void ) const;
 ...
 * **********************************************************************
 */
class CXX_API NcAtt : public NcTypedComponent
{
  public:          
    virtual ~NcAtt( void );
    NcToken name( void ) const;
